...
@RestController
@RequestMapping("/api/pos-rest-api-kafka")
public class PosRestApiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PosRestApiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PosRestApiKafkaResource(KafkaProperties kafkaProperties) {
